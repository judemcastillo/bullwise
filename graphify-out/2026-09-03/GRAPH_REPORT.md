# Graph Report - bullwise  (2026-09-03)

## Corpus Check
- 520 files · ~265,709 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3138 nodes · 7507 edges · 138 communities (130 shown, 8 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 91 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f6e9847a`
...
- market-news-delivery-log.model.ts
- email/run-tests.ts
...
5. `buildTransparentAnalysisAiInput()` - 23 edges
...
### Community 0 - "scripts"
Cohesion: 0.03
Nodes (73): scripts, audit:analysis-broad-combined-strategy-target, audit:backtest-providers, backtest:daily-swing, backtest:daily-swing-batch, backtest:daily-swing-portfolio, backtest:daily-swing-v2-holdout, backtest:daily-swing-v3-holdout (+65 more)

### Community 1 - "crypto-catalog.ts"
Cohesion: 0.12
Nodes (19): CryptoCatalogEntry, currency(), normalizeFinnhubCoinbaseCatalogEntry(), normalizeMassiveCryptoCatalogEntry(), pairKey(), reconcileCoinbaseCryptoCatalogs(), normalizeFinnhubOandaCatalogEntry(), ForexCatalogEntry (+11 more)

### Community 2 - "technical-analysis.ts"
Cohesion: 0.06
Nodes (66): momentumReturn(), annualizedRealizedVolatility(), averageTrueRangeSeries(), exponentialMovingAverageSeries(), macdSeries(), NumericBar, percentageReturn(), relativeStrengthIndexSeries() (+58 more)
...
Cohesion: 0.09
Nodes (44): { GET, POST, PUT }, deliverAlertEmailOutbox(), BetterAuthUser, getVerifiedMarketNewsRecipient(), listMarketNewsRecipientIdsPage(), MarketNewsRecipientPage, PreferenceUserId, ActiveMarketNewsDeliveryLease (+36 more)

### Community 5 - "data/instruments.ts"
Cohesion: 0.15
Nodes (20): InstrumentResolutionError, isDuplicateKeyError(), normalizeFinnhubSymbol(), resolveFinnhubEquityCatalogInstrument(), resolveFinnhubEquityInstrument(), DashboardProfileData, DashboardQuoteData, getListedSecurityQuoteDetails (+12 more)

### Community 6 - "transparent-analysis-ai-selection-evaluation-v1-5.ts"
Cohesion: 0.11
Nodes (33): TRANSPARENT_ANALYSIS_AI_FACTOR_NAMES, TransparentAnalysisAiExplanation, TransparentAnalysisAiFactorName, exactFactText(), factIdsSchema, hasExactKeys(), isRecord(), isUniqueStringArray() (+25 more)

### Community 7 - "scan-analysis-setups.ts"
Cohesion: 0.20
Nodes (14): analyzeDailySwingV2(), applyDailySwingV2Rules(), DAILY_SWING_V2_RULES, plan(), readyResult(), DAILY_SWING_V2_STRATEGY_VERSION, main(), option() (+6 more)

### Community 8 - "backtest-daily-swing-batch.ts"
Cohesion: 0.14
Nodes (19): runDailySwingBatchDiagnosticBacktest(), withFriction(), DAILY_SWING_V2_CONFIRMATION_ID, DAILY_SWING_V2_CONFIRMATION_THRESHOLDS, DailySwingV2Confirmation, evaluateDailySwingV2Confirmation(), maximum(), minimum() (+11 more)
...
### Community 14 - "finnhub-client.ts"
Cohesion: 0.17
...
### Community 15 - "connectToDatabase"
Cohesion: 0.14
Nodes (21): InstrumentPage(), connectToDatabase(), escapeRegExp(), searchCanonicalInstruments(), searchStoredInstruments(), getInstrumentByCanonicalKey(), getWatchlistInstrumentIdsForUser(), getLegacyDailyNewsEmailPreference() (+13 more)

### Community 16 - "analysis-dataset.ts"
Cohesion: 0.09
Nodes (32): buildDailySwingAnalysisDataset(), BuildDatasetInput, CandidateRow, collectRows(), DatasetOutcomeReport, DEFAULT_ANALYSIS_DATASET_SPLIT_RATIOS, features(), FROZEN_CONFIRMATION_SYMBOLS (+24 more)
...
Cohesion: 0.08
Nodes (49): AnalysisDatasetSplit, DAILY_SWING_ANALYSIS_DATASET_VERSION, buildDailySwingEpisodeTrainingDataset(), finiteR(), selectEpisodeFirstRows(), features(), row(), sealedRow() (+41 more)
...
### Community 21 - "watchlist.ts"
Cohesion: 0.08
Nodes (50): WatchlistContent(), ASSET_FILTERS, SearchCommand(), SECURITY_TYPE_FILTERS, applyChanges, EquityInstrument, listingKey(), run() (+42 more)

### Community 22 - "combined-broad-episode-dataset.ts"
Cohesion: 0.09
Nodes (38): AnalysisDatasetSplitSummary, DAILY_SWING_BROAD_SPLIT_BOUNDARIES, DailySwingBroadFeatureVector, DailySwingBroadWalkForwardFold, DAILY_SWING_BROAD_EXPANSION_SETUP_SCAN_SHA256, DAILY_SWING_COMBINED_BROAD_DATASET_VERSION, DAILY_SWING_COMBINED_BROAD_UNIVERSE_NAME, DailySwingCombinedBroadDataset (+30 more)
...
Cohesion: 0.11
Nodes (30): DailySwingBroadCandidateRow, DAILY_SWING_BROAD_WALK_FORWARD_FOLDS, DailySwingInstrumentSetupScan, DailySwingSetupResearchPolicy, DAILY_SWING_SYMMETRIC_REGIME_DEVELOPMENT_ID, DAILY_SWING_SYMMETRIC_REGIME_DEVELOPMENT_PROTOCOL, DAILY_SWING_SYMMETRIC_REGIME_DEVELOPMENT_VERSION, assertFrozenConfiguration() (+22 more)

### Community 28 - "cross-sectional-momentum-runner.ts"
Cohesion: 0.08
Nodes (47): BROAD_DEVELOPMENT_CATEGORIES, BROAD_DEVELOPMENT_V2_EXPANSION_CATEGORIES, ETF_CROSS_SECTIONAL_MOMENTUM_DEVELOPMENT_ID, ETF_CROSS_SECTIONAL_MOMENTUM_DEVELOPMENT_PROTOCOL, ETF_CROSS_SECTIONAL_MOMENTUM_DEVELOPMENT_VERSION, writeMomentumDevelopmentReport(), Costs, EquityPoint (+39 more)

### Community 29 - "types.ts"
Cohesion: 0.06
Nodes (44): invertBars(), invertPositiveDecimal(), invertQuote(), normalizeMarketNumber(), AlpacaBar, AlpacaBarsPayload, AlpacaBarsProvider, AlpacaBarsProviderOptions (+36 more)
...
Cohesion: 0.16
Nodes (18): buildEpisodes(), diagnoseDailySwingTrainingData(), Episode, finiteR(), percentile(), repeatSimilarity(), summarizeTargets(), BASE_FEATURES (+10 more)
...
Cohesion: 0.11
Nodes (25): DailySwingBacktestDependencies, DailySwingBacktestReport, aggregateSummary(), average(), DailySwingBatchBacktestInput, instrumentSummary(), median(), runDailySwingBatchBacktest() (+17 more)
...
Cohesion: 0.15
Nodes (19): AlertDetailsDialog(), AlertDetailsDialogProps, CreateAlertDialog(), CreateAlertDialogProps, CreateAlertDialogState(), instrumentKey(), suggestedThreshold(), SelectField() (+11 more)

### Community 40 - "UserDropdown.tsx"
Cohesion: 0.10
Nodes (20): NavItems(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount(), AvatarImage(), DropdownMenu() (+12 more)

### Community 41 - "setup-scan.ts"
Cohesion: 0.11
Nodes (23): buildBacktestSignalFeatures(), MINIMUM_ANALYSIS_BARS, percentageDistance(), BroadDevelopmentCoverageSnapshot, evaluateBroadDevelopmentCoverage(), BROAD_DEVELOPMENT_V2_EXPANSION_CANDIDATES, BROAD_DEVELOPMENT_V2_EXPANSION_DATA_POLICY, BROAD_DEVELOPMENT_V2_EXPANSION_INCEPTION_CUTOFF (+15 more)

### Community 42 - "OnboardingForm.tsx"
Cohesion: 0.13
Nodes (16): CountrySelectField(), defaultValues, stepFields, stepLabels, PreferencesForm(), cachedSchemaIsCurrent, cachedUserProfile, UserProfileDocument (+8 more)

### Community 43 - "transparent-analysis-route.ts"
Cohesion: 0.20
Nodes (9): TransparentAnalysisOrchestrationResult, handleTransparentAnalysisRequest(), json(), PRIVATE_JSON_HEADERS, unavailableResponse, TransparentAnalysisRouteDependencies, TransparentAnalysisRequestOutcome, AuthenticationError (+1 more)
...
Cohesion: 0.13
Nodes (21): getMarketDataService(), getTransparentAnalysisPanel(), toAnalysisInstrument(), buildTransparentAnalysisOperationalFailureTelemetry(), buildTransparentAnalysisRequestTelemetry(), appendTransparentAnalysisLocalTelemetry(), transparentAnalysisLocalTelemetryPath(), historyBars() (+13 more)

### Community 47 - "onboarding.actions.ts"
Cohesion: 0.20
Nodes (12): OnboardingForm(), completeOnboarding(), saveOnboardingProgress(), AccessControlError, assertCompletedUser(), assertVerifiedUser(), AuthenticatedUser, EmailVerificationRequiredError (+4 more)

### Community 48 - "cn"
Cohesion: 0.08
Nodes (39): CountrySelect(), CountrySelectProps, InputField(), MultiSelectField(), Checkbox(), Command(), CommandDialog(), CommandEmpty() (+31 more)

### Community 49 - "combined-broad-train-diagnostic-runner.test.ts"
Cohesion: 0.27
...
Cohesion: 0.29
Nodes (6): Decision rule, Frozen architecture, Frozen gates, Frozen protocol, Purpose, Transparent analysis AI fact-selection v1.5 preregistration

### Community 52 - "addToCurrentUserWatchlist"
Cohesion: 0.32
Nodes (10): WatchlistButton(), addToWatchlist(), removeFromWatchlist(), revalidateWatchlistViews(), addToCurrentUserWatchlist(), isDuplicateKeyError(), normalizeInstrumentId(), reconcileWatchlistCounter() (+2 more)
...
Cohesion: 0.14
Nodes (27): request(), buildTransparentAnalysisAiInput(), facts(), limitations(), TransparentAnalysisAiInput, boundaryMetrics(), DEFAULT_PROTOCOL, GenerationEvaluationResult (+19 more)
...
### Community 56 - "DashboardWatchlist.tsx"
Cohesion: 0.27
...
Cohesion: 0.07
Nodes (55): applyDailySwingBroadSplitPolicy(), BASE_NULLABLE_FEATURES, baseFeatures(), buildDailySwingBroadDataset(), buildWalkForwardFolds(), collectDailySwingBroadRows(), labels(), OBJECTIVE_FEATURE_KEYS (+47 more)

### Community 58 - "auth.actions.ts"
Cohesion: 0.05
Nodes (52): handler(), SignInPage(), SignUpPage(), VerifyEmailPage(), AuthDivider(), AuthFormError(), FooterLink(), GoogleAuthButton() (+44 more)
...
Cohesion: 0.12
Nodes (20): parseMarketBar(), buildDailySwingObjectiveFeatures(), BuildDailySwingObjectiveFeaturesInput, median(), nearestLevel(), parseBars(), percentileRank(), positiveDollarVolumes() (+12 more)
...
Cohesion: 0.17
Nodes (19): AnalysisDatasetLabels, DailySwingBroadDataset, DailySwingBroadDatasetRow, buildDailySwingBroadEpisodeDataset(), finiteUtility(), requireSource(), rowsBefore(), rowsBetween() (+11 more)
...
Cohesion: 0.15
Nodes (24): CommunicationPreferenceDocument, communicationPreferenceSchema, emailSubscriptionSchema, emailSuppressionSchema, subscriptionsValidationError(), validSubscriptions(), EMAIL_CONSENT_SOURCES, EMAIL_CONSENT_STATUSES (+16 more)

### Community 67 - "baseline-model.ts"
Cohesion: 0.06
Nodes (57): AnalysisDatasetFeatureVector, AnalysisDatasetRow, AnalysisDatasetSplitRatios, DailySwingAnalysisDataset, BacktestSignalQuality, auc(), BASELINE_TRAINING_CONFIGURATION, binaryTarget() (+49 more)
...
Cohesion: 0.11
Nodes (19): WatchlistNews(), WatchlistNewsSection(), articleKey(), buildFinnhubUrl(), fetchArticleList(), FinnhubCompanyProfile, getGeneralNews(), getNews() (+11 more)
...
Cohesion: 0.09
Nodes (41): AlertDetailsDialogState(), applyChanges, EquityInstrument, run(), runMigration(), AlertEventItem, alertEventSchema, EmailDeliveryStatus (+33 more)

### Community 73 - "require-user.ts"
Cohesion: 0.20
Nodes (13): dynamic, GET(), runtime, Layout(), OnboardingPage(), Layout(), PreferencesSettingsPage(), Header() (+5 more)

### Community 74 - "sync-instrument-catalog.ts"
Cohesion: 0.11
Nodes (34): applyChanges, bindingKey(), deactivateOnly, ExistingInstrument, matchingExistingInstruments(), normalizeCatalog(), omittedInstrumentFields(), OPTIONAL_INSTRUMENT_FIELDS (+26 more)

### Community 75 - "transparent-analysis-ai-contract.ts"
Cohesion: 0.18
Nodes (14): exactKeys(), FACTOR_STATES, isRecord(), isStringArray(), numericTokens(), TRANSPARENT_ANALYSIS_AI_EVALUATION_GATES, TransparentAnalysisAiCitedText, TransparentAnalysisAiFact (+6 more)

### Community 76 - "canonical-key.ts"
Cohesion: 0.12
Nodes (25): applyChanges, LegacyMetalInstrument, targetDefinition(), buildCanonicalKey(), CANONICAL_KEY_MAX_LENGTH, CANONICAL_KEY_PATTERN, CanonicalInstrumentIdentity, CommodityIdentity (+17 more)
...
Cohesion: 0.13
Nodes (18): WatchlistSearchParams, Button(), buttonVariants, Table(), TableBody(), TableCaption(), TableCell(), TableFooter() (+10 more)
...
### Community 82 - "transparent-analysis-ai-content-evaluation-v1-4.ts"
Cohesion: 0.14
Nodes (15): TRANSPARENT_ANALYSIS_AI_CONTENT_EVALUATION_V1_2_GATES, TRANSPARENT_ANALYSIS_AI_CONTENT_EVALUATION_V1_2_PROTOCOL, TRANSPARENT_ANALYSIS_AI_CONTENT_EVALUATION_V1_2_VERSION, TRANSPARENT_ANALYSIS_AI_CONTENT_PROMPT_V1_2, TRANSPARENT_ANALYSIS_AI_CONTENT_PROMPT_V1_2_SHA256, TRANSPARENT_ANALYSIS_AI_CONTENT_EVALUATION_V1_3_GATES, TRANSPARENT_ANALYSIS_AI_CONTENT_EVALUATION_V1_3_MINIMUM_COMPLETION_PERCENT, TRANSPARENT_ANALYSIS_AI_CONTENT_EVALUATION_V1_3_PROTOCOL (+7 more)

### Community 83 - "transparent-analysis-daily-observation.ts"
Cohesion: 0.23
Nodes (15): DAILY_CANDIDATES, increment(), incrementStringArray(), isRecordedDate(), isValidInstrumentRequest(), StoredTelemetryLine, summarizeTransparentAnalysisObservation(), TRANSPARENT_ANALYSIS_OBSERVATION_MINIMUM_REQUESTS (+7 more)
...
Cohesion: 0.13
Nodes (21): FetchImplementation, geminiCompatibleSchema(), GeminiResponse, GOOGLE_TRANSPARENT_ANALYSIS_AI_CANDIDATE, GoogleTransparentAnalysisAiProvider, httpFailureCategory(), outputText(), retryAfterSeconds() (+13 more)

### Community 87 - "transparent-analysis-operational-review.ts"
Cohesion: 0.23
Nodes (12): TRANSPARENT_ANALYSIS_OBSERVATION_MINIMUM_DAYS, buildTransparentAnalysisOperationalReview(), count(), OperationalReviewGate, percent(), TRANSPARENT_ANALYSIS_OPERATIONAL_REVIEW_PATH, TRANSPARENT_ANALYSIS_OPERATIONAL_REVIEW_VERSION, TransparentAnalysisOperationalReview (+4 more)
...
### Community 94 - "market-news-delivery-log.model.ts"
Cohesion: 0.50
Nodes (3): MarketNewsDeliveryLogDocument, marketNewsDeliveryLogSchema, MarketNewsDeliveryStatus

### Community 95 - "email/run-tests.ts"
Cohesion: 0.17
...
Cohesion: 0.17
Nodes (16): NotificationSettingsPage(), categoryLabels, frequencyOptions, NotificationsForm(), preferenceKey(), updateMarketNewsPreference(), MARKET_NEWS_CATEGORIES, MarketNewsPreferenceInput (+8 more)
...
### Community 102 - "RISK_CONTROLLED_MOMENTUM_V3_PROTOCOL"
Cohesion: 0.42
...
### Community 124 - "communication-eligibility.ts"
Cohesion: 0.24
Nodes (8): BetterAuthUser, getEmailEligibility(), getPreference(), EmailEligibilityRequest, EmailEligibilityResult, evaluateEmailEligibility(), hasAuditableConsent(), streamForMessage()
...
### Community 138 - "combined-broad-fold-dataset.types.ts"
Cohesion: 0.17
...
### Community 140 - "symmetric-regime-history-source.ts"
Cohesion: 0.25
Nodes (8): DEFAULT_BACKTEST_CONFIGURATION, BacktestConfiguration, parseTrainMarketBars(), readFrozenSymmetricTrainHistory(), SerializedBatchHistory, SerializedMarketBar, SerializedMarketBars, validDate()
...
## Knowledge Gaps
- **744 isolated node(s):** `metadata`, `sections`, `metadata`, `sections`, `MARKET_SUMMARY_WIDGET_CONFIG` (+739 more)
...
- **Why does `connectToDatabase()` connect `connectToDatabase` to `market-news-preference.ts`, `processor.ts`, `functions.ts`, `data/instruments.ts`, `email-suppression.ts`, `user-alerts.ts`, `require-user.ts`, `email-delivery.ts`, `transparent-analysis-telemetry.ts`, `onboarding.actions.ts`, `mongoose.ts`, `addToCurrentUserWatchlist`, `watchlist.ts`, `auth.actions.ts`, `communication-eligibility.ts`, `index.ts`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `AssetClass` connect `watchlist.ts` to `global.d.ts`, `technical-analysis.ts`, `user-alerts.ts`, `sync-instrument-catalog.ts`, `connectToDatabase`, `processor.ts`, `types.ts`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `EquitySecurityType` connect `watchlist.ts` to `global.d.ts`, `technical-analysis.ts`, `equity-catalog.ts`, `connectToDatabase`, `fetch-backtest-history.ts`, `transparent-analysis-orchestrator.ts`?**
...
- **Should `crypto-catalog.ts` be split into smaller, more focused modules?**
