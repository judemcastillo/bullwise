...
## Corpus Check
- 568 files · ~305,189 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3630 nodes · 8719 edges · 159 communities (152 shown, 7 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 108 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4fd0a951`
...
## Communities (159 total, 7 thin omitted)
...
Cohesion: 0.11
Nodes (22): TransparentAnalysisAiLimitation, allFacts(), hasExactKeys(), isRecord(), isUniqueStringArray(), LIMITATION_TEXT, TransparentAnalysisAiQuestionRoutingGenerationResult, questionRequiresProhibitedRoute() (+14 more)

### Community 2 - "technical-analysis.types.ts"
Cohesion: 0.09
Nodes (28): plan(), readyResult(), buildDailySwingObjectiveFeatures(), BuildDailySwingObjectiveFeaturesInput, median(), nearestLevel(), parseBars(), percentileRank() (+20 more)
...
Cohesion: 0.10
Nodes (37): { GET, POST, PUT }, deliverAlertEmailOutbox(), BetterAuthUser, getVerifiedMarketNewsRecipient(), listMarketNewsRecipientIdsPage(), MarketNewsRecipientPage, PreferenceUserId, createMarketNewsDeliveryEvents() (+29 more)

### Community 5 - "data/instruments.ts"
Cohesion: 0.12
Nodes (25): InstrumentPage(), getInstrumentByCanonicalKey(), InstrumentResolutionError, isDuplicateKeyError(), normalizeFinnhubSymbol(), resolveFinnhubEquityCatalogInstrument(), resolveFinnhubEquityInstrument(), isCanonicalKey() (+17 more)

### Community 6 - "transparent-analysis-ai-selection-evaluation-v1-5.ts"
Cohesion: 0.11
Nodes (33): TransparentAnalysisAiExplanation, TransparentAnalysisAiFactorName, TRANSPARENT_ANALYSIS_AI_PROVIDER_PACING_MINIMUM_OBSERVED_INTERVAL_MS, exactFactText(), factIdsSchema, hasExactKeys(), isRecord(), isUniqueStringArray() (+25 more)
...
Cohesion: 0.11
Nodes (17): auditProviderSeries(), BacktestProviderAuditReport, dateKey(), median(), percentile(), ProviderSeriesAudit, THRESHOLDS, AlpacaBar (+9 more)

### Community 10 - "connectToDatabase"
Cohesion: 0.10
Nodes (37): WatchlistContent(), WatchlistButton(), connectToDatabase(), addToWatchlist(), removeFromWatchlist(), revalidateWatchlistViews(), mapWithConcurrency(), createDevelopmentAlertEmailTestEvent() (+29 more)
...
Cohesion: 0.14
Nodes (25): fitBaselineLinearModel(), predictBaselineProbabilities(), sigmoid(), DAILY_SWING_COMBINED_BROAD_FOLD_DATASET_SHA256, average(), binaryTargets(), CombinedBroadCandidateReport, CombinedBroadDevelopmentActuals (+17 more)
...
Cohesion: 0.12
Nodes (29): BaselineTrainingConfiguration, CombinedBroadFeatureEncoder, average(), averageRanks(), buildCohorts(), categoricalValue(), CohortMetric, EpisodeRow (+21 more)

### Community 19 - "episode-validation.ts"
Cohesion: 0.11
Nodes (33): compareClassificationToConstantBaseline(), DAILY_SWING_EPISODE_DATASET_VERSION, DailySwingEpisodeTrainingDataset, EpisodeTrainingRow, EpisodeTrainingTarget, preregisterDailySwingEpisodeExperiment(), sha256(), DAILY_SWING_EPISODE_EXPERIMENT_FROZEN_SHA256 (+25 more)
...
### Community 22 - "broad-dataset.types.ts"
Cohesion: 0.15
Nodes (22): AnalysisDatasetSplitSummary, DailySwingBroadDatasetRow, DailySwingBroadWalkForwardFold, DAILY_SWING_COMBINED_BROAD_DATASET_VERSION, DAILY_SWING_COMBINED_BROAD_UNIVERSE_NAME, DailySwingCombinedBroadDataset, DailySwingCombinedBroadDatasetRow, DailySwingCombinedBroadSourceScan (+14 more)

### Community 23 - "constants.ts"
Cohesion: 0.07
Nodes (36): Home(), MARKET_SUMMARY_WIDGET_CONFIG, DASHBOARD_TOP_STORIES_WIDGET_CONFIG, DashboardNews(), CountrySelectField(), defaultValues, stepFields, stepLabels (+28 more)

### Community 24 - "backtest.ts"
Cohesion: 0.09
Nodes (37): applySlippage(), buyAndHoldReturn(), calculateBaselines(), entryBasePrice(), groupMetrics(), isStopTouched(), isTargetTouched(), marketBarsThrough() (+29 more)
...
Cohesion: 0.11
Nodes (29): DailySwingBroadCandidateRow, DailySwingInstrumentSetupScan, DailySwingSetupResearchPolicy, DAILY_SWING_SYMMETRIC_REGIME_DEVELOPMENT_ID, DAILY_SWING_SYMMETRIC_REGIME_DEVELOPMENT_PROTOCOL, DAILY_SWING_SYMMETRIC_REGIME_DEVELOPMENT_VERSION, assertFrozenConfiguration(), buildDailySwingSymmetricCandidateRows() (+21 more)
...
### Community 29 - "tiingo-eod-client.ts"
Cohesion: 0.18
Nodes (10): errorMessage(), parseBar(), TiingoEodBar, TiingoEodProvider, TiingoEodProviderOptions, TiingoError, validateRequest(), FakeBarsProvider (+2 more)
...
Cohesion: 0.26
Nodes (10): exactKeys(), FACTOR_STATES, isRecord(), isStringArray(), numericTokens(), TransparentAnalysisAiCitedText, TransparentAnalysisAiValidationIssueCode, TransparentAnalysisAiValidationResult (+2 more)

### Community 35 - "combined-broad-strategy-redesign-runner.ts"
Cohesion: 0.13
Nodes (23): selectEpisodeFirstBroadRows(), DAILY_SWING_COMBINED_BROAD_STRATEGY_REDESIGN_ID, DAILY_SWING_COMBINED_BROAD_STRATEGY_REDESIGN_PROTOCOL, DAILY_SWING_COMBINED_BROAD_STRATEGY_REDESIGN_VERSION, average(), BenchmarkInput, benchmarkRiskAt(), cohortMetrics() (+15 more)

### Community 36 - "transparent-analysis-panel.types.ts"
Cohesion: 0.09
Nodes (33): AnalysisState, TechnicalAnalysisUnavailableReason, TechnicalAnalysisUnavailableResult, panel, analysisPanelContext(), APPROVED_WARNING_MAP, approvedWarnings(), BuildAnalysisPanelInput (+25 more)
...
Cohesion: 0.11
Nodes (17): invertBars(), invertPositiveDecimal(), invertQuote(), marketStateForCalendar(), normalizeMarketNumber(), FinnhubQuotePayload, FinnhubQuoteProvider, FinnhubQuoteProviderOptions (+9 more)
...
Cohesion: 0.20
Nodes (14): writeDailySwingSetupScanReport(), writeLargeJsonObjectWithArray(), writeText(), DailySwingSetupScanReport, main(), main(), main(), option() (+6 more)

### Community 43 - "buildTransparentAnalysisAiInput"
Cohesion: 0.10
Nodes (45): request(), buildTransparentAnalysisAiInput(), facts(), limitations(), TRANSPARENT_ANALYSIS_AI_FACTOR_NAMES, TransparentAnalysisAiFact, boundaryMetrics(), boundaryResult() (+37 more)
...
Cohesion: 0.16
Nodes (22): buildTransparentAnalysisAiQuestionRoutingInput(), boundaryMetrics(), containsAll(), containsOnly(), evaluateTransparentAnalysisAiQuestionRoutingV1(), exactRenderedText(), expectedSelectionSatisfied(), expectedTransparentAnalysisAiQuestionRoutingOutput() (+14 more)

### Community 47 - "types/instruments.ts"
Cohesion: 0.09
Nodes (42): ASSET_FILTERS, SearchCommand(), SECURITY_TYPE_FILTERS, INSTRUMENT_TYPES_BY_ASSET_CLASS, InstrumentContract, instrumentContractSchema, InstrumentItem, instrumentSchema (+34 more)

### Community 48 - "market-news-preference.ts"
Cohesion: 0.14
Nodes (19): NotificationSettingsPage(), categoryLabels, frequencyOptions, NotificationsForm(), preferenceKey(), updateMarketNewsPreference(), EmailConsentSource, EmailSubscriptionPreferenceSnapshot (+11 more)

### Community 49 - "risk-controlled-momentum-v2-universe.ts"
Cohesion: 0.17
...
Cohesion: 0.15
Nodes (20): auc(), BASELINE_TRAINING_CONFIGURATION, binaryTarget(), CATEGORICAL_FEATURES, compareRegressionToConstantBaseline(), encodeBaselineFeatureRows(), EncodedBaselineRows, evaluateClassificationMetrics() (+12 more)
...
Cohesion: 0.12
Nodes (23): Layout(), OnboardingPage(), Layout(), PreferencesSettingsPage(), OnboardingForm(), PreferencesForm(), completeOnboarding(), saveOnboardingProgress() (+15 more)
...
Cohesion: 0.17
Nodes (18): AnalysisDatasetLabels, DAILY_SWING_BROAD_SPLIT_BOUNDARIES, DailySwingBroadDataset, buildDailySwingBroadEpisodeDataset(), finiteUtility(), requireSource(), rowsBefore(), rowsBetween() (+10 more)
...
Cohesion: 0.21
Nodes (15): DailySwingBroadFeatureVector, clip(), COMBINED_BROAD_CATEGORICAL_FEATURES, COMBINED_BROAD_NUMERIC_FEATURES, encodeCombinedBroadFeatureRows(), finite(), fitCombinedBroadFeatureEncoder(), median() (+7 more)
...
Cohesion: 0.07
Nodes (46): applyChanges, bindingKey(), deactivateOnly, ExistingInstrument, matchingExistingInstruments(), normalizeCatalog(), omittedInstrumentFields(), OPTIONAL_INSTRUMENT_FIELDS (+38 more)
...
### Community 71 - "AlertDialogs.tsx"
Cohesion: 0.08
Nodes (44): AlertDetailsDialog(), AlertDetailsDialogProps, AlertDetailsDialogState(), CreateAlertDialog(), CreateAlertDialogProps, CreateAlertDialogState(), instrumentKey(), suggestedThreshold() (+36 more)
...
Cohesion: 0.15
Nodes (16): availablePanel(), boundaryPanel, context(), generationFixtures, generationSpecifications, momentumFacts(), MomentumState, participationFacts() (+8 more)
...
### Community 78 - "symmetric-regime-history-source.ts"
Cohesion: 0.15
Nodes (15): DEFAULT_BACKTEST_CONFIGURATION, buildProviderAuditReport(), parseTrainMarketBars(), readFrozenSymmetricTrainHistory(), SerializedBatchHistory, SerializedMarketBar, SerializedMarketBars, validDate() (+7 more)

### Community 79 - "communication-policy.ts"
Cohesion: 0.10
Nodes (24): applyChanges, MigrationSummary, runMigration(), BetterAuthUser, getEmailEligibility(), getPreference(), COMMUNICATION_POLICY_VERSION, COMMUNICATION_PREFERENCE_SCHEMA_VERSION (+16 more)
...
Cohesion: 0.09
Nodes (34): dynamic, GET(), runtime, TransparentAnalysisOrchestrationResult, handleTransparentAnalysisRequest(), json(), PRIVATE_JSON_HEADERS, unavailableResponse (+26 more)

### Community 83 - "transparent-analysis-ai-question-routing-fixtures.ts"
Cohesion: 0.13
Nodes (24): analysisDetailFixtures, BoundaryFixture, BoundaryFixtureBase, boundaryFixtures, clarifyFixtures, context(), contextFixtures, expected() (+16 more)
...
Cohesion: 0.12
Nodes (23): geminiCompatibleSchema(), GeminiResponse, GOOGLE_TRANSPARENT_ANALYSIS_AI_CANDIDATE, GoogleTransparentAnalysisAiEvaluationRequest, GoogleTransparentAnalysisAiProvider, httpFailureCategory(), outputText(), retryAfterSeconds() (+15 more)

### Community 87 - "transparent-analysis-ai-evaluation.ts"
Cohesion: 0.09
Nodes (37): TRANSPARENT_ANALYSIS_AI_CONTENT_EVALUATION_V1_2_GATES, TRANSPARENT_ANALYSIS_AI_CONTENT_EVALUATION_V1_2_PROTOCOL, TRANSPARENT_ANALYSIS_AI_CONTENT_EVALUATION_V1_2_VERSION, TRANSPARENT_ANALYSIS_AI_CONTENT_PROMPT_V1_2, TRANSPARENT_ANALYSIS_AI_CONTENT_PROMPT_V1_2_SHA256, TRANSPARENT_ANALYSIS_AI_CONTENT_EVALUATION_V1_3_GATES, TRANSPARENT_ANALYSIS_AI_CONTENT_EVALUATION_V1_3_MINIMUM_COMPLETION_PERCENT, TRANSPARENT_ANALYSIS_AI_CONTENT_EVALUATION_V1_3_PROTOCOL (+29 more)
...
Cohesion: 0.07
Nodes (35): BacktestTrade, DailySwingBatchDiagnosticReport, DailySwingBatchDiagnostics, DiagnosticTradeMetrics, FrictionSensitivityResult, activeAtOpen(), activeOpeningExposure(), Candidate (+27 more)
...
### Community 97 - "combined-broad-fold-dataset.ts"
Cohesion: 0.24
...
### Community 100 - "cn"
Cohesion: 0.07
Nodes (47): CountrySelect(), CountrySelectProps, Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount(), AvatarImage() (+39 more)

### Community 101 - "canonical-key.ts"
Cohesion: 0.11
Nodes (27): applyChanges, LegacyMetalInstrument, runMigration(), targetDefinition(), prepareCommodityCatalog(), buildCanonicalKey(), CANONICAL_KEY_MAX_LENGTH, CANONICAL_KEY_PATTERN (+19 more)
...
### Community 103 - "analysis/run-tests.ts"
Cohesion: 0.19
Nodes (9): writeRiskControlledMomentumV3Report(), AnalysisPanelResponse, buildTransparentAnalysisSmokeFailure(), buildTransparentAnalysisSmokeSummary(), TRANSPARENT_ANALYSIS_SMOKE_VERSION, TransparentAnalysisSmokeFailure, TransparentAnalysisSmokeSummary, validateTransparentAnalysisSmokeArguments() (+1 more)
...
Cohesion: 0.07
Nodes (46): BacktestSignalFeatures, applyDailySwingBroadSplitPolicy(), BASE_NULLABLE_FEATURES, baseFeatures(), buildDailySwingBroadDataset(), buildWalkForwardFolds(), collectDailySwingBroadRows(), labels() (+38 more)
...
Cohesion: 0.20
Nodes (9): Defensive context: acceptance-generation-09, Finding, Implementation checkpoint result, Lightweight production observation, Mixed context: acceptance-generation-06, Overview selection and AI ordering product review, Presentation comparisons, Recommendation and implementation scope (+1 more)
...
Cohesion: 0.08
Nodes (37): dynamic, POST(), runtime, buildTransparentAnalysisAiSynthesisInput(), CitedSynthesisText, citedTextSchema, exactKeys(), factorFacts() (+29 more)
...
### Community 130 - "combined-broad-train-source.ts"
Cohesion: 0.19
...
Cohesion: 0.20
Nodes (15): DailySwingAnalysisDataset, buildEpisodes(), diagnoseDailySwingTrainingData(), Episode, finiteR(), percentile(), repeatSimilarity(), summarizeTargets() (+7 more)
...
Cohesion: 0.12
Nodes (24): DiagnosticTradeGroup, analyzeDailySwingV2(), applyDailySwingV2Rules(), DAILY_SWING_V2_RULES, DailySwingAnalysisInput, DAILY_SWING_V2_STRATEGY_VERSION, TechnicalAnalysisResult, DAILY_SWING_V2_CONFIRMATION_ID (+16 more)
...
### Community 147 - "alert-event.model.ts"
Cohesion: 0.16
...
### Community 149 - "select.tsx"
Cohesion: 0.22
Nodes (11): SelectField(), Select(), SelectContent(), SelectGroup(), SelectItem(), SelectLabel(), SelectScrollDownButton(), SelectScrollUpButton() (+3 more)

### Community 150 - "watchlist/page.tsx"
Cohesion: 0.25
Nodes (6): WatchlistSearchParams, WatchlistAlerts(), WatchlistNewsLoading(), WatchlistPageLoading(), WatchlistPagination(), WatchlistSearch()

### Community 151 - "baseline-model.types.ts"
Cohesion: 0.18
Nodes (12): BaselineFeatureEncoder, BaselineLinearModel, CategoricalFeatureTransform, ClassificationMetrics, DAILY_SWING_BASELINE_MODEL_VERSION, DailySwingBaselineModelReport, NumericFeatureTransform, RegressionMetrics (+4 more)
...
### Community 153 - "risk-controlled-momentum-v3-source.ts"
Cohesion: 0.44
...
### Community 154 - "DashboardWatchlist.tsx"
Cohesion: 0.27
Nodes (7): DashboardWatchlist(), DashboardWatchlistItem, StockLogo(), StockLogoProps, ScrollArea(), ScrollBar(), formatCurrencyValue()

### Community 155 - "mongoose.ts"
Cohesion: 0.33
Nodes (6): runMigration(), applyChanges, EquityInstrument, listingKey(), run(), listFinnhubUsEquitySymbols()

### Community 156 - "backtest.test.ts"
Cohesion: 0.28
Nodes (5): bar(), historicalBars(), longPlan(), SIGNAL_AT, simulate()

### Community 157 - "combined-broad-model-development.ts"
Cohesion: 0.36
...
### Community 161 - "transparent-analysis-ai-provider-reliability.ts"
Cohesion: 0.18
Nodes (13): GoogleTransparentAnalysisAiProviderError, GoogleTransparentAnalysisAiProviderFailureCategory, evaluateTransparentAnalysisAiProviderPacing(), TRANSPARENT_ANALYSIS_AI_PROVIDER_PACING_INTERVAL_MS, TRANSPARENT_ANALYSIS_AI_PROVIDER_PACING_MINIMUM_COMPLETION_PERCENT, TRANSPARENT_ANALYSIS_AI_PROVIDER_PACING_VERSION, failure(), FAILURE_CATEGORIES (+5 more)

## Knowledge Gaps
- **914 isolated node(s):** `metadata`, `sections`, `metadata`, `sections`, `MARKET_SUMMARY_WIDGET_CONFIG` (+909 more)
...
- **Why does `AnalysisPanelResponse` connect `analysis/run-tests.ts` to `transparent-analysis-ai-question-routing.ts`, `transparent-analysis-ai-contract.ts`, `transparent-analysis-panel.types.ts`, `transparent-analysis-ai-selection-evaluation-v1-5.ts`, `transparent-analysis-ai-topic-routing-v2.ts`, `buildTransparentAnalysisAiInput`, `transparent-analysis-ai-selection-acceptance-v1-fixtures.ts`, `transparent-analysis-telemetry.ts`, `transparent-analysis-ai-question-routing-fixtures.ts`, `transparent-analysis-orchestrator.ts`, `transparent-analysis-ai-evaluation.ts`, `transparent-analysis-ai-fixtures.ts`, `transparent-analysis-ai-topic-routing-v3-fixtures.ts`, `DailyMarketAnalysisCard.tsx`, `transparent-analysis-ai-production.ts`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `connectToDatabase` to `functions.ts`, `data/instruments.ts`, `email-suppression.ts`, `index.ts`, `email-delivery.ts`, `types/instruments.ts`, `communication-policy.ts`, `market-news-preference.ts`, `transparent-analysis-telemetry.ts`, `require-user.ts`, `auth.actions.ts`, `processor.ts`, `mongoose.ts`, `market-news-delivery-log.ts`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `AssetClass` connect `types/instruments.ts` to `global.d.ts`, `technical-analysis.types.ts`, `sync-instrument-catalog.ts`, `AlertDialogs.tsx`, `types.ts`, `connectToDatabase`, `massive-bars-client.ts`, `market-data/service.test.ts`, `processor.ts`?**
